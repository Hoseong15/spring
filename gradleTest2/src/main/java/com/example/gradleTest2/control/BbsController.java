...
/*
	...
	프로그램 설계 - 스프링(controller -> DAO(DTO)
		...
		데이터베이스 - mybatis
			...
			mybatis메퍼: SimpleBbsDao xml
			
			BbsController
				목록 : /list(GET) - public String listPage(Model model)메서드
				글쓰기 : /writeForm(GET) - public String writeForm
					   /write(POST) - public String write(@Valid SimpleBbsDto simpleBbsDto,
					    			  BindingResult bind, Model model)메서드
				글보기 : /view(GET) - public String view(@RequestParam String id, Model model)메서드
				글수정 : /updateForm(POST) - public String updateForm(@RequestParam Sting id, Model model)메슫
